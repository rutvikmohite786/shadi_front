...
<div class="py-8">
    <div class="container">
        ...
        @if(isset($viewed) && count($viewed) > 0)
                ...
                @foreach($viewed as $view)
                    <div class="card">
                        ...
                        <div class="flex gap-2 p-4" style="border-top: 1px solid var(--gray-100);">
                            ...
                            <form action="{{ route('interests.send', $view->viewed->id) }}" method="POST" class="interest-form" data-user-id="{{ $view->viewed->id }}" style="flex: 1;">
                                @csrf
            ...
            @if(method_exists($viewed, 'hasPages') && $viewed->hasPages())
                <div class="mt-6">
                    {{ $viewed->links() }}
                </div>
            @endif
